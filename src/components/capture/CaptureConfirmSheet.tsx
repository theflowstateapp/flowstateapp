...
import { AITaskDraft, ProposedBlock, CaptureConfirmProps } from '../../types/capture';

const CaptureConfirmSheet: React.FC<CaptureConfirmProps> = ({ draft, onClose, onAccept }) => {
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  {['PROJECT', 'AREA', 'RESOURCE', 'INBOX'].map((bucket) => (
                    <button
                      key={bucket}
                      onClick={() => setFormData({ ...formData, paraBucket: bucket as any })}
