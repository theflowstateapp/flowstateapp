...
const ProjectAnalyticsDashboard = () => {
  ...
  useEffect(() => {
    // Load analytics data
    const loadAnalytics = () => {
      const analyticsInsights = ProjectAnalytics.getProductivityInsights();
      const analyticsRecommendations = ProjectAnalytics.getRecommendations();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto p-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Project Analytics Dashboard</h1>
          <p className="text-gray-600 text-lg">Insights and recommendations to improve your project management</p>
        </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{insights.projectCreation.totalProjects}</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-gray-900">
                      {insights.projectCreation.mostCommonType || 'N/A'}
                    </p>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="space-y-3">
                  {insights.patterns.commonProjectTypes.map((type, index) => (
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-24 bg-gray-200 rounded-full h-2">
                          <div 
                            ...
                            style={{ width: `${(type.count / Math.max(...insights.patterns.commonProjectTypes.map(t => t.count))) * 100}%` }}
                          ></div>
                        </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="space-y-3">
                  {insights.patterns.commonCategories.map((category, index) => (
                    <div key={index} className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="w-24 bg-gray-200 rounded-full h-2">
                          <div 
                            ...
                            style={{ width: `${(category.count / Math.max(...insights.patterns.commonCategories.map(c => c.count))) * 100}%` }}
                          ></div>
                        </div>
        ...
        {activeTab === 'productivity' && (
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Area Distribution */}
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Life Areas</h3>
                <div className="space-y-3">
                  {insights.patterns.commonAreas.map((area, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <span className="text-sm font-medium text-gray-700">{area.name}</span>
                      <span className="text-sm text-gray-500">{area.count} projects</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Duration Patterns */}
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Duration Patterns</h3>
                <div className="space-y-3">
                  {insights.patterns.durationPatterns.map((duration, index) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      <span className="text-sm font-medium text-gray-700">{duration.name}</span>
                      <span className="text-sm text-gray-500">{duration.count} times</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              {recommendations.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">Create more projects to get personalized recommendations!</p>
                </div>
              )}
            </div>
          </motion.div>
