-- Life OS Complete Database Schema Migration
-- This script creates a complete schema with all required fields
-- It will work whether tables exist or not
...
CREATE INDEX idx_tasks_life_area ON public.tasks(life_area_id);
CREATE INDEX idx_tasks_do_date ON public.tasks(do_date);
CREATE INDEX idx_tasks_deadline ON public.tasks(deadline_date);
CREATE INDEX idx_tasks_important ON public.tasks(is_important);
CREATE INDEX idx_tasks_urgent ON public.tasks(is_urgent);
CREATE INDEX idx_tasks_parent ON public.tasks(parent_task_id);
CREATE INDEX idx_tasks_priority_matrix ON public.tasks(priority_matrix);

CREATE INDEX idx_projects_user_id ON public.projects(user_id);
CREATE INDEX idx_projects_life_area ON public.projects(life_area_id);
...
CREATE INDEX idx_life_areas_user_id ON public.life_areas(user_id);

CREATE INDEX idx_task_projects_task ON public.task_projects(task_id);
CREATE INDEX idx_task_projects_project ON public.task_projects(project_id);

CREATE INDEX idx_task_goals_task ON public.task_goals(task_id);
CREATE INDEX idx_task_goals_goal ON public.task_goals(goal_id);

CREATE INDEX idx_task_dependencies_blocking ON public.task_dependencies(blocking_task_id);
CREATE INDEX idx_task_dependencies_blocked ON public.task_dependencies(blocked_task_id);

CREATE INDEX idx_time_tracking_task ON public.time_tracking(task_id);
